...
export async function deployProtocolFixture() {
  ...
  const deployment = {
    ...
    performanceFeeHWM: new PerformanceFeeHWM(fixture['PerformanceFeeHWM'].address, deployer),
    performanceFeeHurdle: new PerformanceFeeHurdle(fixture['PerformanceFeeHurdle'].address, deployer),
    protocolFee: new ProtocolFee(fixture['ProtocolFee'].address, deployer),
    streamingFee: new StreamingFee(fixture['StreamingFee'].address, deployer),
